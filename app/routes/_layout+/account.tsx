  ...
  return (
    <div className="flex w-full flex-col items-center justify-start px-6 py-12 md:h-full">
      <div className="flex flex-col items-center">
        <h3 className="text-3xl font-bold text-accent-foreground">Account</h3>
        <div className="my-1" />
      </div>
      <div className="my-6" />
      ...
      <div className="flex w-full max-w-2xl flex-col items-center md:flex-row md:justify-evenly">
        ...
        <div className="my-8 flex h-full w-full flex-col items-center md:my-0">
          ...
          {/* Info. */}
          <div className="flex flex-col items-center">
            <h5 className="flex flex-row items-center text-center text-2xl font-bold text-accent-foreground">
        ...
        <Card className="w-[380px]">
          <CardTitle>
            <h5 className="my-4 text-center text-2xl font-bold text-accent-foreground">
          ...
          <CardContent>
            <div className="flex flex-col items-center">
              <span className="text-center text-lg font-semibold text-accent-foreground">
                {subscription.planId === PlanId.FREE &&
                  PRICING_PLANS[PlanId.FREE].description}

                {subscription.planId === PlanId.SUPPORTER &&
                  PRICING_PLANS[PlanId.SUPPORTER].description}
              </span>
            </div>
            <div className="my-3" />
          </CardContent>
              ...
              {subscription.planId === PlanId.FREE && (
                <>
                  <Link
                    to="/plans"
                    prefetch="intent"
                    className="flex h-10 w-48 flex-row items-center justify-center rounded-xl bg-accent-foreground px-6 
                  font-bold text-primary-foreground transition hover:scale-105 hover:brightness-125 active:opacity-80">
